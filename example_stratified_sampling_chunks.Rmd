...
Now do the stratified sampling. This can be done in nested loops but this gets messy the more strata there are. So I've tried to make this more easily scalable. In this example there are two methods for sampling: 'random' sampling or 'tophits', where the latter just gives the N highest scoring detections. Ultimately, I can pass the output locations to the extract_chunk function which will automatically make any required folders.
