...
#' 
#' @param path_csv = string, the path and filename of the results csv file
#'
...
#' @export
#' 
read_pipeline_results <- function(path_csv) {
  
  #read the results file
  results <- read.csv(path_csv, stringsAsFactors = FALSE, na.strings = c('NA','null'))
